...
public class UItest {
	public static void main(String[] args) throws InterruptedException {
		 ...
		 */ 
		String url ="https://rahulshettyacademy.com/getCourse.php?state=verifyfjdss&code=4%2F0gGEgBEf0a4XKkmKjINiBcvoj7qwvZ_BRD7t1bLcfi7mNTNq7jMHsAjM65NdGGTZfsdLU6qVfGTqtLjJMtV6CG4&scope=email+openid+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email&authuser=0&prompt=none#";
		...
		String resp2 = given().contentType("application/json")
